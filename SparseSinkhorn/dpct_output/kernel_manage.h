...
template <int MAXELEMENT>
void update_alpha(COO_Sparese_Matrix<MAXELEMENT> *kernel,
                             XData *alphaH,
                                  double eps,int num,double *mu,int layer);
template <int MAXELEMENT>
void update_beta(COO_Sparese_Matrix<MAXELEMENT> *kernel,
                             XData *alphaH,
                                  double eps,int num,double *mu,int layer);
template <int MAXELEMENT>
void transport_kernel(COO_Sparese_Matrix<MAXELEMENT> * kernel,
                                 COO_Sparese_Matrix<MAXELEMENT> *kernelT);

template <int MAXELEMENT>
void check_cells_(int layer,int layerBottom,
                                double eps,
                                double slack,
...
template <int MAXELEMENT>
void scoreTransportCost(XData *xPos,XData *yPos,
                                   double *res,double *u,double *v,
                                   int N,COO_Sparese_Matrix<MAXELEMENT> *kernel,int layer);


template <int MAXELEMENT>
void refine_kernel_2(COO_Sparese_Matrix<MAXELEMENT> *newkernel,
...
inline double EUCL_lincombSqr(double * a,
                                   double * b) {
