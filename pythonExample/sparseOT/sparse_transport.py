...
def log_sinkhorn_sparse(sp_matrix, indices,a, b):
    def get_K( alpha, beta,reg, col_, row_, crow, col, n,m):
    ...
    numIterinner = [50,10,10,10,10,10]
    ...
    while loop:
        ...
        if cpt % 1 == 0:
            ...
            res = get_K( f, g,regk ,col_, row_, crow, col, n,m)
            res = torch.squeeze(res)
            res -= torch.squeeze(a)
            res2 = get_K( g, f,regk ,colT_, rowT_, crowT, colT, m,n)
