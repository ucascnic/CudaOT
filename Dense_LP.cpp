...
int test_read_data32_32(){
    ...
    int n = 32;
    string filex,filey;
    filex = "/home/chenyidong/data/ot_benchmark/CauchyDensity/data"+ to_string(n)+"_1001.dat";
    filey = "/home/chenyidong/data/ot_benchmark/CauchyDensity/data"+ to_string(n)+"_1002.dat";
    ...
    // dimensions of grid
    int dim = 2;
    std::vector<int> muXdim(dim,n);
    std::vector<int> muYdim(dim,n);
...
int W2Grid_64x64() {
    ...
    char filenameMuX[]="data/grid/001_064.dat";
    char filenameMuY[]="data/grid/002_064.dat";
